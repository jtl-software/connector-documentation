...
All primary key mapper classes implement the interface `Jtl\Connector\Core\Mapper\PrimaryKeyMapperInterface <https://github.com/jtl-software/connector-core/blob/2.6/src/Mapper/IPrimaryKeyMapper.php>`_.
