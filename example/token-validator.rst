...
It thus delegates this task to the endpoint, communicating via an object of interface `Jtl\Connector\Core\Authentication\TokenValidatorInterface <https://github.com/jtl-software/connector-core/blob/2.6/src/Authentication/ITokenLoader.php>`_.
